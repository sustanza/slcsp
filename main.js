...
const main = async (
    ...
    // create a date object for start time performance analysis
    ...
    // create a date object for stop time performance analysis
    const stop = new Date()

    // print the total execution time for performance analysis
    console.log(
        `Executing time = ${(stop.getTime() - start.getTime()) / 1000} seconds`
    )
}
